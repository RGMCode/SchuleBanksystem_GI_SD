...
INSERT INTO Customer (LastName, FirstName, ContactID, BankID, Birthdate, StaffID)
VALUES ('Brill', 'Daniel', 1, 1, '01.01.1997', 1),
       ('von Althoff', 'Lorenzo', 2, 1, '01.01.1995', 2),
       ('Mengedoth', 'René', 3, 2, '27.10.1989', 3),
       ('Lipke', 'Piet', 4, 2, '31.05.1993', 4),
       ('Wagner', 'Julia', 5, 3, '05.05.2000', 5),
       ('Becker', 'Jan', 6, 3, '06.06.2005', 5),
       ('Bauer', 'Jana', 7, 4, '07.07.2010', 4),
       ('Hoffmann', 'Lena', 8, 4, '08.08.2001', 3),
       ('Schmitz', 'Kim', 9, 5, '09.09.1980', 2),
       ('Friedrich', 'Sarah', 10, 5, '10.10.2005', 1);
...
(
    ...
    Birthdate     TEXT    NOT NULL,
    AccTypStaffID INTEGER NOT NULL,
    FOREIGN KEY (AccTypStaffID) REFERENCES AccTypStaff (AccTypStaffID)
);

INSERT INTO Staff (LastName, FirstName, Birthdate, AccTypStaffID)
VALUES ('Brill', 'Daniel', '23.09.1998', 4),
       ('von Althoff', 'Lorenzo', '01.01.1995', 3),
       ('Lipke', 'Piet', '31.05,1993', 2),
       ('Mengedoth', 'René', '01.01.0001', 1);
...
(
    AccStatusID INTEGER PRIMARY KEY,
    Description VARCHAR(255) NOT NULL
);
...
(
    LoginTyp    INTEGER PRIMARY KEY AUTO_INCREMENT,
    Description VARCHAR(255) NOT NULL
);

INSERT INTO LoginTyp (Description)
VALUES ('Customer'),
       ('Staff'),
       ('Card');
...
CREATE TABLE Login
(
    LoginID    INTEGER PRIMARY KEY AUTO_INCREMENT,
    LoginTyp   INTEGER NOT NULL,
